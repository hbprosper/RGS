...
def main():
    ...
    rgs.add(filename1, start, numrows, "_VBF", VBFscale, selection)
    rgs.add(filename2, start, numrows, "_ggF", ggFscale, selection)
    rgs.add(filename3, start, numrows, "_ZZ",  ZZscale,  selection)
